$(function(){        
    ...
    Morris.Line({
      ...
      data: [
        { y: '2015-10-15', a: 2,b: 4},
        { y: '2015-11-15', a: 4,b: 6},
        { y: '2015-12-15', a: 7,b: 10},
        { y: '2016-01-15', a: 5,b: 7},
        { y: '2016-02-15', a: 6,b: 9},
        { y: '2016-03-15', a: 9,b: 12},
        { y: '2016-04-15', a: 18,b: 20}
      ],
      xkey: 'y',
      ykeys: ['a','b'],
      labels: ['Repeated','Unique'],
      resize: true,
      hideHover: true,
      xLabels: 'day',
      gridTextSize: '10px',
